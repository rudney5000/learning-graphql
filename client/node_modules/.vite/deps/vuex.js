//#region node_modules/.pnpm/vuex@3.6.2_vue@2.7.16/node_modules/vuex/dist/vuex.esm.js
/*!
* vuex v3.6.2
* (c) 2021 Evan You
* @license MIT
...
function applyMixin(Vue) {
	if (Number(Vue.version.split(".")[0]) >= 2) Vue.mixin({ beforeCreate: vuexInit });
	else {
...
var devtoolHook = (typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : {}).__VUE_DEVTOOLS_GLOBAL_HOOK__;
...
var Store = function Store(options) {
	...
	if (options.devtools !== void 0 ? options.devtools : Vue.config.devtools) devtoolPlugin(this);
};
